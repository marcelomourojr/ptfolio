  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl">
        ...
        <p className="mt-6 text-[clamp(1.25rem,3.2vw,2.25rem)] font-medium leading-[1.15] tracking-[-0.025em] text-white/90">
          {statement}
        </p>
      </div>

      {/* Bloco inferior: assinatura em escala máxima + metadados */}
      <div>
